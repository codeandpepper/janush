...
export const cloudTemplateGenerator = (options: Schema): Rule => {
  return async (tree: Tree, _context: SchematicContext) => {
    ...
    return chain([
      ...
      isUsersManagementModule(options)
        ? schematic(CloudSchematic.USERS_MANAGEMENT_CREATE_GROUPS, options)
        : noop(),
      isUsersManagementModule(options)
        ? schematic(CloudSchematic.USERS_MANAGEMENT_GET_GROUPS, options)
        : noop(),
