...
export const expectedFiles = [
  ...
  "/web/src/layouts/NavigationDrawer/NavigationDrawer.tsx",
  "/web/src/layouts/NavigationDrawer/index.ts",
  "/web/src/layouts/NavigationDrawer/styles.ts",
  ...
  "/web/src/layouts/TopAppBar/styles.ts",
